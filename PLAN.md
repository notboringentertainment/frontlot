...
- **D4 Seedance 2.5 primary; model is a scene-level property, override per scene with reason, never mixed within a scene.** Rejected: per-shot choice (documented drift cause; round 2 briefly introduced it, round 3 removed it).
